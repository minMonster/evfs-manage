  ...
  <div class="setup">
    <div class="set-inner  abs">
      ...
      <div class="abs set-right">
        ...
        <new-chain-league @next="next" v-if="curStep == 'step4.2'"></new-chain-league>
        <new-chain-administrator @next="next" v-if="curStep == 'step4.3'"></new-chain-administrator>
        <!-- <configure @next="next" v-if="curStep == 'step4.4'"></configure> -->
        <!-- <new-chain-permission @next="next" v-if="curStep == 'step4.4'"></new-chain-permission> -->
...
const steps = [
  ...
  { text: '4.创建新的链，或加入现有的链',
    ...
    new: [
      ...
      // { text: '4.4.链前置节点访问许可配置', name: 'step4.4' }
    ],
    join: [
...
export default {
  components: {
    ...
    'new-chain-league': league, // 'league':
    'new-chain-administrator': administrator // 'administrator':
    // configure,
    // 'new-chain-permission': permission // 'permission':
